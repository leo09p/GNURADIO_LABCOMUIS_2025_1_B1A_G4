...
# Title: Cuantizador No uniforme UISPractica5
# Author: Leo_Edwar
...
class CuantizadorClase(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Cuantizador No uniforme UISPractica5", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Cuantizador No uniforme UISPractica5")
        ...
        for c in range(0, 1):
            self.tab_channel_grid_layout_0.setColumnStretch(c, 1)
        self._amplitude_range = qtgui.Range(0, 10, 0.1, 5, 200)
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/estudiante/Descargas/WhatsApp-Ptt-2025-05-13-at-5.23.33-PM.wav', True)
