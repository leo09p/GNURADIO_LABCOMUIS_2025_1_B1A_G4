...
# Title: Lab1_punto5_Muestreo
# Author: Leonel_Araque_Edwar_Diaz_B1A_G4
...
class Lab_comu_1_punto5(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab1_punto5_Muestreo", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab1_punto5_Muestreo")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Lab_comu_1_punto5")
...
def main(top_block_cls=Lab_comu_1_punto5, options=None):
