...
class Practica1B(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._A_win = qtgui.RangeWidget(self._A_range, self.set_A, "Amplitude señal TX", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.uhd_usrp_sink_0.set_samp_rate(195.312e3)
