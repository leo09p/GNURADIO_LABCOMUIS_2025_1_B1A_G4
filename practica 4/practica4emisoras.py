...
class practica4emisoras(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "emisoras", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("emisoras")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "practica4emisoras")
        ...
        self._fcb_win = qtgui.RangeWidget(self._fcb_range, self.set_fcb, "Frecuencia de corte de filtro ", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fcb_win)
        self._fc_range = qtgui.Range(88e6, 108e6, 1e5, 90.7e6, 200)
        self._fc_win = qtgui.RangeWidget(self._fc_range, self.set_fc, "Fecuencia de la señal Portadora", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=practica4emisoras, options=None):
